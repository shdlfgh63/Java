...
%>                    
           ...
           <p class="card-text">강의가 많고 널널해서 많이 배운것 없지만 성적이 좋게 나옵니다</p>
            <div class="row">
                ...
                <div class="col-3 text-right">
                   <a onclick="return confirm('추천하시겠습니끼?')" href="./likeAction.jsp?evaluationID=">추천</a>
                   <a onclick="return confirm('추천하시겠습니끼?')" href="./delte Action.jsp?evaluationID=">삭제</a>
                </div>
           </div>
      </div>
   ...
   <div class="card bg-light mt-3">
      <div class="card-header bg-light">
         <div class="row">
             <div class="col-8 text-left">컴퓨터 그래픽&nbsp;<small>나동빈</small></div>
               <div class="col-4 text-right">
                  종합<span style="color: red;">A</span>
              </div>
         </div>
      ...
      <div class="card-body">
           <h5 class="card-tilte">
              좋은 강의에요.&nbsp;<small>(2017년 가을학기)</small>         
           </h5>
           <p class="card-text">성적이 좋게 나옵니다</p>
            <div class="row">
                <div class="col-9 text-left">
                    성적<span style="color: red;">A</span>
                    널널<span style="color: red;">A</span>
   ...
   <div class="card bg-light mt-3">
      <div class="card-header bg-light">
         <div class="row">
             <div class="col-8 text-left">컴퓨터시스템&nbsp;<small>나동빈</small></div>
               <div class="col-4 text-right">
                  종합<span style="color: red;">A</span>
              </div>
         </div>
